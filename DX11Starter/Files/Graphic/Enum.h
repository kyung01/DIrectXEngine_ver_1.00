...
namespace NGraphic {
	enum KEnum {
		...
		RENDER_TYPE_DEFERRED_LIGHT_INDIRECT,
		RENDER_TYPE_DEFERRED_LIGHT_INDIRECT_BLUR,
		RENDER_TYPE_DEFERRED_LIGHT_INDIRECT_BLUR_VERTICALLY,
		RENDER_TYPE_DEFERRED_LIGHT_INDIRECT_APPLY,
